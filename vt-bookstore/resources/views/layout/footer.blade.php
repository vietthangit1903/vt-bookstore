                        ...
                        <div class="pb-6">
                            ...
                            <div class="mb-4">
                                <a href="mailto:vietthang@vtbookstore.com"
                                    class="font-size-2 d-block link-black-100 mb-1">vietthang@vtbookstore.com</a>
                                <a href="tel:+84 292 3 734713" class="font-size-2 d-block link-black-100">+84 292 3 734713</a>
                            </div>
        ...
        <div class="space-1">
            <div class="container">
                <div class="d-lg-flex text-center text-lg-left justify-content-between align-items-center">
                    ...
                    <p class="mb-3 mb-lg-0 font-size-2">©2022 VT Bookstore. All rights reserved</p>
